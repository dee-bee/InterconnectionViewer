...
function callGraph_findCallsFromRoot(svgDocumentNode, filePath){
    var svgConnections = []
...
function doIt(url){
    ...
    //Grab the file list
    parseDoxygenFileList(url, function(t_doxIndex_GeneratedXml){
                       ...
                       $.ajax({
                            ...
                            success: function(svgDocumentNode) {           
                                ...
                                if(d3JsonOutputArr[filePath] == undefined){
                                    d3JsonOutputArr[filePath] = {imports:[],fromTo:[]}
                                }

                                var callGraphOutput = callGraph_findCallsFromRoot(svgDocumentNode, filePath)
